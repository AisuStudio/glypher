...
- **No coordinate calibration.** Fontane's canvas doesn't know your font's
  ...
  factor that works, set `SCALE` at the top of the script. (Note: the web
  app's own OTF/TTF exports already use a real baseline/ascender/bearing
  calibration for glyphs drawn in Grid View — this script hasn't been
